// Resend email helper + branded HTML templates for Daniel Ahart Tax Services

const RESEND_API_KEY = Deno.env.get("RESEND_API_KEY") ?? "";
const FROM_EMAIL =
  Deno.env.get("FROM_EMAIL") ??
  "Daniel Ahart Tax Services <noreply@danielahart.com>";
...
// ---------------------------------------------------------------------------
// HTML email templates (ported from src/lib/email/templates.ts)
// ---------------------------------------------------------------------------
...
export function reminderFirstEmail(office: OfficeInfo) {
  ...
  const html = baseTemplate(`
    ...
    <p style="text-align: center; margin: 24px 0;">
      <a href="${APP_URL}/office/dashboard" class="btn">Submit Report</a>
    </p>
...
export function reminderFinalEmail(office: OfficeInfo) {
  ...
  const html = baseTemplate(`
    ...
    <p style="text-align: center; margin: 24px 0;">
      <a href="${APP_URL}/office/dashboard" class="btn">Submit Report Now</a>
    </p>
...
export function adminNotificationEmail(
  ...
  const html = baseTemplate(`
    ...
    <p style="text-align: center; margin: 24px 0;">
      <a href="${APP_URL}/admin/dashboard" class="btn">View in Admin Portal</a>
    </p>
  `);
